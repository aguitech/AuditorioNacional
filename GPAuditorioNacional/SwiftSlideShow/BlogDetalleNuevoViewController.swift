...
class BlogDetalleNuevoViewController: UIViewController, ENSideMenuDelegate {
    ...
    @IBAction func backButton(sender: AnyObject) {
        ...
        let registroPantalla = nuestroStoryBoard.instantiateViewControllerWithIdentifier("ViewController1") as! BlogMyNavigationController
    ...
    @IBAction func toHomeView(sender: AnyObject) {
        let nuestroStoryBoard: UIStoryboard = UIStoryboard(name:"Main", bundle:nil)
